...
# Load the dataset
df = pd.read_csv(r"C:/Users/CL/Desktop/diabetes.csv")
# print(df.head())
# print(df.info())

# check if their is null values 
...
# Box plot to see if their is any outliers
...
# Identify the quartiles for Insulin
...
# Identity the quartiles for Pregnancies
